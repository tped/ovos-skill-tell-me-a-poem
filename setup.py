...
URL = "https://github.com/tped/ovos-skill-tell-me-a-poem"
SKILL_CLAZZ = "TellMeAPoemSkill"  # needs to match __init__.py class name
PYPI_NAME = "ovos-skill-tell-me-a-poem"  # pip install PYPI_NAME
